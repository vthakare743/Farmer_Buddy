<%@ Page Title="" Language="C#" MasterPageFile="~/USER/LoginMasterPage.master" AutoEventWireup="true" CodeFile="Schemes.aspx.cs" Inherits="USER_Schemes" %>
            ...
            <div class="panel-body">
              ...
              <img src='photo/<%# Eval("photo") %>' height="85px" width="85px" style="border-radius:50%" BorderStyle="Double"/>
                         ...
                         <asp:HyperLink ID="HyperLink1"  CssClass="mdi mdi-border-color" runat="server" 
                             NavigateUrl='<%#"~/USER/ViewScheme.aspx?gid=" + Server.UrlEncode(Eval("gid").ToString()) %>' > View</asp:HyperLink>
