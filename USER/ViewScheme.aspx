<%@ Page Title="" Language="C#" MasterPageFile="~/USER/LoginMasterPage.master" AutoEventWireup="true" CodeFile="ViewScheme.aspx.cs" Inherits="USER_ViewScheme" %>
        ...
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                <form role="form">
                                   ...
                                   <div class="row">
                                       ...
                                       <div class="card">
                                           <div class="col-lg-4">
                                               ...
                                               <asp:Label ID="Label2" runat="server" Text="Scheme Name :-"  ForeColor="#00ccff"></asp:Label>
                                               ...
                                               <br />
                                                            ...
                                                            <asp:Label ID="lblmrp" runat="server" Text='<%# Eval("amount") %>'></asp:Label>
                                                            <br />
                    ...
                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/USER/Schemes.aspx">Back</asp:HyperLink>
